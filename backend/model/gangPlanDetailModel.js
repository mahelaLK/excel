    ...
    try {
        ...
        const gangResult = await pool.request()
            ...
            for (const gangNumber of gangNumbers){
                ...
                .query(`
                    SELECT VPS_GangPlanHeader.BerthSide, VPS_GangPlanHeader.Crane, VPS_GangPlanHeader.Discharge, VPS_GangPlanHeader.Overstow, VPS_GangPlanHeader.Restow, VPS_GangPlanHeader.Loads, VPS_ShiftPlanHeader.ShiftPlanHeaderID, VPS_ShiftPlanHeader.ShiftNumber, VPS_ShiftPlanHeader.ShiftStartDate, VPS_ShiftPlanHeader.Supervisor, VPS_GangPlanDetail.ListOfBays
...
module.exports = { getAllGangPlanDetail };